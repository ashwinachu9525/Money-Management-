...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-auto min-h-[4rem] pt-[env(safe-area-inset-top,0px)] items-center gap-4 border-b bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md px-4 md:px-6">
